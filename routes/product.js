...
const { productGet, getProductsArko, getProductsVitromex, getProductById, getProductsVitromexCMS, getProductsARKOCMS, changeStatusProduct } = require('../controllers/product');
